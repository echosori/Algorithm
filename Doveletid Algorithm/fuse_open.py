...
# 컴퓨터 한대에 하나의 모니터가 있다.
# 퓨즈는 각 모든 소비 전기의 최소 두 배를 견딜수 있는 것으로 준비해야 한다.
# 그리고 퓨즈의 용량은 10 , 20 , 30 , ... 10 의 배수 단위로 사용된다.
#
# 입력
#
# 입력은 세 개의 음이 아닌 정수가 주어진다. 차례대로 컴퓨터 , 프린터 , 라우터의 수이다.
...
if ((a+b+c)*2)%10!=0:
    print(int(((a+b+c)*2//10+1)*10),'amperes')
else:
    print(int((a+b+c)*2//10)*10,'amperes')