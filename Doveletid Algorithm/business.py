# # http://119.201.123.184/30stair/business/business.php?pname=business
# 프로그램 명: business
#
# 4 개의 정수가 입력으로 주어진다.
#
...
# n   원가 -- 40
# m  정가(판매가) -- 70
# p   손님이 물건값으로 지불한 돈 중 가짜 돈 -- 50
# c   주인이 손님에게 거스름돈으로 지불한 돈 -- 20

n,m,p,c=(int(x) for x in input().split())
print(n+p-m)